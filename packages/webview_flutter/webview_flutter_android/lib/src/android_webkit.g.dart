...
class PigeonInstanceManager {
  ...
  static PigeonInstanceManager _initInstance() {
    ...
    RenderProcessGoneDetail.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
...
class RenderProcessGoneDetail extends PigeonInternalProxyApiBaseClass {
  /// Constructs [RenderProcessGoneDetail] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  RenderProcessGoneDetail.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    RenderProcessGoneDetail Function(
      bool didCrash,
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.webview_flutter_android.RenderProcessGoneDetail.pigeon_newInstance',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.RenderProcessGoneDetail.pigeon_newInstance was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(arg_pigeon_instanceIdentifier != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.RenderProcessGoneDetail.pigeon_newInstance was null, expected non-null int.');
          final bool? arg_didCrash = (args[1] as bool?);
          assert(arg_didCrash != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.RenderProcessGoneDetail.pigeon_newInstance was null, expected non-null bool.');
          final int? arg_rendererPriorityAtExit = (args[2] as int?);
            ...
            (pigeon_instanceManager ?? PigeonInstanceManager.instance)
              ...
              pigeon_newInstance?.call(
                  ...
                  RenderProcessGoneDetail.pigeon_detached(
                    pigeon_binaryMessenger: pigeon_binaryMessenger,
                    pigeon_instanceManager: pigeon_instanceManager,
                    didCrash: arg_didCrash!,
                    rendererPriorityAtExit: arg_rendererPriorityAtExit!,
                  ),
              arg_pigeon_instanceIdentifier!,
            );
            return wrapResponse(empty: true);
  ...
  @override
  RenderProcessGoneDetail pigeon_copy() {
    return RenderProcessGoneDetail.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      didCrash: didCrash,
...
class WebViewClient extends PigeonInternalProxyApiBaseClass {
  ...
  /// final WeakReference weakMyVariable = WeakReference(myVariable);
  /// final WebViewClient instance = WebViewClient(
  ///  onRenderProcessGone: (WebViewClient pigeon_instance, ...) {
  ///    print(weakMyVariable?.target);
  ///  },
  /// );
  /// ```
  ...
  static void pigeon_setUpMessageHandlers({
...

    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.webview_flutter_android.WebViewClient.onRenderProcessGone',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.WebViewClient.onRenderProcessGone was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final WebViewClient? arg_pigeon_instance =
              (args[0] as WebViewClient?);
          assert(arg_pigeon_instance != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.WebViewClient.onRenderProcessGone was null, expected non-null WebViewClient.');
          final WebView? arg_webView = (args[1] as WebView?);
          assert(arg_webView != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.WebViewClient.onRenderProcessGone was null, expected non-null WebView.');
          final RenderProcessGoneDetail? arg_data =
              (args[2] as RenderProcessGoneDetail?);
          assert(arg_data != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.WebViewClient.onRenderProcessGone was null, expected non-null RenderProcessGoneDetail.');
          try {
            final bool? output = (onRenderProcessGone ??
                    arg_pigeon_instance!.onRenderProcessGone)
                ?.call(arg_pigeon_instance!, arg_webView!, arg_data!);
  ...
  Future<void>
    ...
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const String pigeonVar_channelName =
        'dev.flutter.pigeon.webview_flutter_android.WebViewClient.setSynchronousReturnValueForApplicationDidHandleWebViewRenderProcessCrash';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
